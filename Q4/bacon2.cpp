...
int main(){
    ...
    Actor *a_b = imdb_a.returnNode("Denzel Washington");
    ...
    Actor *b_b = imdb_b.returnNode("Denzel Washington");
    ...
    Graph imdb_c;
    imdb_c.readData();
    Actor *c_a = imdb_c.returnNode("Adam Sandler (I)");
    Actor *c_b = imdb_c.returnNode("Denzel Washington");
